...
func _on_enter() -> void:
	if player.facing_direction == Vector2.UP:
		...
		hit_component_collision_shape_2d.position = Vector2(0, -18)
	elif player.facing_direction == Vector2.DOWN:
		animated_sprite_2d.play("chopping_front")
		hit_component_collision_shape_2d.position = Vector2(0, 3)
	elif player.facing_direction == Vector2.LEFT:
		animated_sprite_2d.play("chopping_left")
		hit_component_collision_shape_2d.position = Vector2(-9, 0)
